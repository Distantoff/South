...
',
  ...
  array (
    '[[pdoMenu?
                                &parents=`0`
                                &level=`1`]]' => '<ul class=""><li class="first"><a href="/" >Home</a></li><li><a href="about" >About</a></li><li><a href="houses/" >Houses</a></li><li><a href="blog/" >Blog</a></li><li class="last active"><a href="contact" >Contact</a></li></ul>',
    '[[pdoMenu?
                                &parents=`0`
                                &level=`1`
                                &outerClass=`useful-links-nav`]]' => '<ul class="useful-links-nav"><li class="first"><a href="/" >Home</a></li><li><a href="about" >About</a></li><li><a href="houses/" >Houses</a></li><li><a href="blog/" >Blog</a></li><li class="last active"><a href="contact" >Contact</a></li></ul>',
  ),
  'sourceCache' => 
  array (
    'modChunk' => 
